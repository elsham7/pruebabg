        ...
        <aside className="left-sidebar">
            <div className="scroll-sidebar">
                <nav className="sidebar-nav">
                    <ul id="sidebarnav">
                        {/* <li className="user-pro"> <Link className="has-arrow waves-effect waves-dark" to="#" aria-expanded="false"><img src="imagenes/1.jpg" alt="user-img" className="img-circle" /><span className="hide-menu">{stateApp.user}</span></Link>
                        <ul aria-expanded="false" className="collapse">
                            <li><Link to="#"><i className="ti-user"></i> My Profile</Link></li>
                            <li><Link to="#"><i className="ti-wallet"></i> My Balance</Link></li>
                            <li><Link to="#"><i className="ti-email"></i> Inbox</Link></li>
                            <li><Link to="#"><i className="ti-settings"></i> Account Setting</Link></li>
                            <li><Link to="#"><i className="fa fa-power-off"></i> Logout</Link></li>
                        </ul>
                    </li> */}
                        {/* <li> <Link className="waves-effect waves-dark" to="#"><i className="icon-speedometer"></i><span className="hide-menu">Dashboard</span></Link>
                    </li> */}
                        <li> <Link className="has-arrow waves-effect waves-dark" to="#" aria-expanded="false"><i className="ti-layout-grid2"></i><span className="hide-menu">Apps</span></Link>
                            <ul aria-expanded="false" className="collapse">
                                <li><Link to="/general/mantenimiento/sucursal">Mi Carrito</Link></li>
                            </ul>
                        </li>
                    ...
                    <li> <a className="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i className="ti-palette"></i><span className="hide-menu">Ui Elements <span className="badge badge-pill badge-primary text-white ml-auto">25</span></span></a>
                        <ul aria-expanded="false" className="collapse">
                    ...
                    <li> <a className="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i className="ti-calendar"></i><span className="hide-menu">Appointment</span></a>
                        <ul aria-expanded="false" className="collapse">
                            <li><a href="doctor-schedule.html">Doctor Schedule</a></li>
                            <li><a href="book-appointment.html">Book Appointment</a></li>
                        </ul>
                    </li>
                    <li> <a className="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i className="fa fa-user-md"></i><span className="hide-menu">Doctors</span></a>
                        <ul aria-expanded="false" className="collapse">
                    ...
                    <li> <a className="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i className="icon-people"></i><span className="hide-menu">Patients</span></a>
                        <ul aria-expanded="false" className="collapse">
                    ...
                    <li> <a className="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i className="fas fa-rupee-sign"></i><span className="hide-menu">Payments</span></a>
                        <ul aria-expanded="false" className="collapse">
                    ...
                    <li>
                        <a className="waves-effect waves-dark" href="../documentation/documentation.html" aria-expanded="false">
